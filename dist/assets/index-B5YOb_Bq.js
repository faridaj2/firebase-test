 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gt=()=>pt().__FIREBASE_DEFAULTS__,mt=()=>{if(typeof process>"u"||typeof ue>"u")return;const e=ue.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},bt=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&ht(e[1]);return t&&JSON.parse(t)},wt=()=>{try{return gt()||mt()||bt()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},Oe=()=>{var e;return(e=wt())===null||e===void 0?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et="FirebaseError";class S extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=Et,Object.setPrototypeOf(this,S.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,M.prototype.create)}}class M{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},o=`${this.service}/${t}`,i=this.errors[t],s=i?_t(i,r):"Error",a=`${this.serviceName}: ${s} (${o}).`;return new S(o,a,r)}}function _t(e,t){return e.replace(vt,(n,r)=>{const o=t[r];return o!=null?String(o):`<${r}?>`})}const vt=/\{\$([^}]+)}/g;function z(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const o of n){if(!r.includes(o))return!1;const i=e[o],s=t[o];if(de(i)&&de(s)){if(!z(i,s))return!1}else if(i!==s)return!1}for(const o of r)if(!n.includes(o))return!1;return!0}function de(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ut(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ut(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Y="@firebase/app",pe="0.10.16";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g=new Bt("@firebase/app"),Wt="@firebase/app-compat",qt="@firebase/analytics-compat",zt="@firebase/analytics",Gt="@firebase/app-check-compat",Jt="@firebase/app-check",Yt="@firebase/auth",Xt="@firebase/auth-compat",Qt="@firebase/database",Zt="@firebase/data-connect",en="@firebase/database-compat",tn="@firebase/functions",nn="@firebase/functions-compat",rn="@firebase/installations",on="@firebase/installations-compat",sn="@firebase/messaging",an="@firebase/messaging-compat",cn="@firebase/performance",un="@firebase/performance-compat",dn="@firebase/remote-config",ln="@firebase/remote-config-compat",fn="@firebase/storage",hn="@firebase/storage-compat",pn="@firebase/firestore",gn="@firebase/vertexai",mn="@firebase/firestore-compat",bn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class En{constructor(t,n,r){this._isDeleted=!1,this._options=Object.assign({},t),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new w("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw m.create("app-deleted",{appName:this._name})}}function $e(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:X,automaticDataCollectionEnabled:!1},t),o=r.name;if(typeof o!="string"||!o)throw m.create("bad-app-name",{appName:String(o)});if(n||(n=Oe()),!n)throw m.create("no-options");const i=N.get(o);if(i){if(z(n,i.options)&&z(r,i.config))return i;throw m.create("duplicate-app",{appName:o})}const s=new Dt(o);for(const c of Q.values())s.addComponent(c);const a=new En(n,r,s);return N.set(o,a),a}function _n(e=X){const t=N.get(e);if(!t&&e===X&&Oe())return $e();if(!t)throw m.create("no-app",{appName:e});return t}function b(e,t,n){var r;let o=(r=wn[e])!==null&&r!==void 0?r:e;n&&(o+=`-${n}`);const i=o.match(/\s|\//),s=t.match(/\s|\//);if(i||s){const a=[`Unable to register library "${o}" with version "${t}":`];i&&a.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&a.push("and"),s&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),g.warn(a.join(" "));return}E(new w(`${o}-version`,()=>({library:o,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nn(e){E(new w("platform-logger",t=>new Kt(t),"PRIVATE")),E(new w("heartbeat",t=>new Cn(t),"PRIVATE")),b(Y,pe,e),b(Y,pe,"esm2017"),b("fire-js","")}Nn("");var Bn="firebase",Mn="11.0.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */b(Bn,Mn,"app");const je="@firebase/installations",ne="0.6.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const He=1e4,xe=`w:${ne}`,Ve="FIS_v2",Rn="https://firebaseinstallations.googleapis.com/v1",Pn=60*60*1e3,$n="installations",Ln="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ie(e,t=!1){let n;const r=await $(e.appConfig,i=>{if(!tt(i))throw _.create("not-registered");const s=i.authToken;if(!t&&ar(s))return i;if(s.requestStatus===1)return n=ir(e,t),i;{if(!navigator.onLine)throw _.create("app-offline");const a=ur(i);return n=sr(e,a),a}});return n?await n:r.authToken}async function ir(e,t){let n=await Ie(e.appConfig);for(;n.authToken.requestStatus===1;)await Je(100),n=await Ie(e.appConfig);const r=n.authToken;return r.requestStatus===0?ie(e,t):r}function Ie(e){return $(e,t=>{if(!tt(t))throw _.create("not-registered");const n=t.authToken;return dr(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function sr(e,t){try{const n=await rr(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await B(e.appConfig,r),n}catch(n){if(Ke(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Ze(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await B(e.appConfig,r)}throw n}}function tt(e){return e!==void 0&&e.registrationStatus===2}function ar(e){return e.requestStatus===2&&!cr(e)}function cr(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Pn}function ur(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function dr(e){return e.requestStatus===1&&e.requestTime+He<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lr(e){const t=e,{installationEntry:n,registrationPromise:r}=await oe(t);return r?r.catch(console.error):ie(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fr(e,t=!1){const n=e;return await hr(n),(await ie(n,t)).token}async function hr(e){const{registrationPromise:t}=await oe(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nt="installations",gr="installations-internal",mr=e=>{const t=e.getProvider("app").getImmediate(),n=pr(t),r=te(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},br=e=>{const t=e.getProvider("app").getImmediate(),n=te(t,nt).getImmediate();return{getId:()=>lr(n),getToken:o=>fr(n,o)}};function wr(){E(new w(nt,mr,"PUBLIC")),E(new w(gr,br,"PRIVATE"))}wr();b(je,ne);b(je,ne,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yr="/firebase-messaging-sw.js",Ir="/firebase-cloud-messaging-push-scope",rt="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Er="https://fcmregistrations.googleapis.com/v1",ot="google.c.a.c_id",_r="google.c.a.c_l",vr="google.c.a.ts",Sr="google.c.a.e";var Ee;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Ee||(Ee={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U="fcm_token_details_db",Tr=5,_e="fcm_token_object_Store";async function Dr(e){if("databases"in indexedDB&&!(await indexedDB.databases()).map(i=>i.name).includes(U))return null;let t=null;return(await R(U,Tr,{upgrade:async(r,o,i,s)=>{var a;if(o<2||!r.objectStoreNames.contains(_e))return;const c=s.objectStore(_e),d=await c.index("fcmSenderId").get(e);if(await c.clear(),!!d){if(o===2){const u=d;if(!u.auth||!u.p256dh||!u.endpoint)return;t={token:u.fcmToken,createTime:(a=u.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:u.auth,p256dh:u.p256dh,endpoint:u.endpoint,swScope:u.swScope,vapidKey:typeof u.vapidKey=="string"?u.vapidKey:h(u.vapidKey)}}}else if(o===3){const u=d;t={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:h(u.auth),p256dh:h(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:h(u.vapidKey)}}}else if(o===4){const u=d;t={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:h(u.auth),p256dh:h(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:h(u.vapidKey)}}}}}})).close(),await j(U),await j("fcm_vapid_details_db"),await j("undefined"),Cr(t)?t:null}function Cr(e){if(!e||!e.subscriptionOptions)return!1;const{subscriptionOptions:t}=e;return typeof e.createTime=="number"&&e.createTime>0&&typeof e.token=="string"&&e.token.length>0&&typeof t.auth=="string"&&t.auth.length>0&&typeof t.p256dh=="string"&&t.p256dh.length>0&&typeof t.endpoint=="string"&&t.endpoint.length>0&&typeof t.swScope=="string"&&t.swScope.length>0&&typeof t.vapidKey=="string"&&t.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kr="firebase-messaging-database",Or=1,C="firebase-messaging-store";let W=null;function it(){return W||(W=R(kr,Or,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(C)}}})),W}async function Nr(e){const t=st(e),r=await(await it()).transaction(C).objectStore(C).get(t);if(r)return r;{const o=await Dr(e.appConfig.senderId);if(o)return await se(e,o),o}}async function se(e,t){const n=st(e),o=(await it()).transaction(C,"readwrite");return await o.objectStore(C).put(t,n),await o.done,t}function st({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===D.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Se(n)):e.onMessageHandler.next(Se(n)));const r=n.data;Ur(r)&&r[Sr]==="1"&&await Yr(e,n.messageType,r)}const Ae="@firebase/messaging",Te="0.12.14";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function no(){try{await Be()}catch{return!1}return typeof window<"u"&&Ne()&&It()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ro(e=_n()){return no().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),te(Me(e),"messaging").getImmediate()}async function oo(e,t){return e=Me(e),ct(e,t)}to();const io={apiKey:"AIzaSyBgrvali7O7aNZazdai_Gh1nBIcc2FCp6Y",authDomain:"test-d30ea.firebaseapp.com",projectId:"test-d30ea",storageBucket:"test-d30ea.firebasestorage.app",messagingSenderId:"636987858623",appId:"1:636987858623:web:a71f77a5e79ef2d4d4f00a",measurementId:"G-8MTVH1VKWY"},so=$e(io),ao=ro(so);function co(){Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),oo(ao,{vapidKey:"BKR3M4vyA_kUFwmdErwwQb7Xg360bwmp8JendZkeF7oOMdv1tKH1Ce7f53y3rDqTuLQbrztMTmEfdMac67A_uo8"}).then(t=>{t?(console.log("Token: ",t),document.getElementById("app").innerHTML=t):console.log("No registration token available.")}).catch(t=>{console.log("An error occurred while retrieving token: ",t)})):console.log("Unable to get permission to notify.")})}co();"serviceWorker"in navigator&&navigator.serviceWorker.register("./firebase-messaging-sw.js").then(function(e){console.log("Service Worker berhasil terdaftar:",e)}).catch(function(e){console.error("Pendaftaran Service Worker gagal:",e)});
