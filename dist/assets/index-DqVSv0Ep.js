 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function or({appConfig:e,heartbeatServiceProvider:t},n){const r=ir(e,n),o=jn(e,n),i=t.getImmediate({optional:!0});if(i){const d=await i.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={installation:{sdkVersion:xe,appId:e.appId}},s={method:"POST",headers:o,body:JSON.stringify(a)},c=await Ge(()=>fetch(r,s));if(c.ok){const d=await c.json();return We(d)}else throw await qe("Generate Auth Token",c)}function ir(e,{fid:t}){return`${Ue(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function io(e=vn()){return ro().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),ne(ee(e),"messaging").getImmediate()}async function ao(e,t){return e=ee(e),ct(e,t)}function so(e,t){return e=ee(e),oo(e,t)}no();const co={apiKey:"AIzaSyBgrvali7O7aNZazdai_Gh1nBIcc2FCp6Y",authDomain:"test-d30ea.firebaseapp.com",projectId:"test-d30ea",storageBucket:"test-d30ea.firebasestorage.app",messagingSenderId:"636987858623",appId:"1:636987858623:web:a71f77a5e79ef2d4d4f00a",measurementId:"G-8MTVH1VKWY"},uo=$e(co),ut=io(uo);ao(ut,{vapidKey:"BKR3M4vyA_kUFwmdErwwQb7Xg360bwmp8JendZkeF7oOMdv1tKH1Ce7f53y3rDqTuLQbrztMTmEfdMac67A_uo8"}).then(e=>{e?(console.log("Token: ",e),document.getElementById("app").innerHTML=e):console.log("No registration token available.")}).catch(e=>{console.log("An error occurred while retrieving token: ",e)});function lo(){Notification.requestPermission().then(e=>{console.log(e==="granted"?"Notification permission granted.":"Unable to get permission to notify.")})}lo();so(ut,function(e){console.log("Pesan diterima:",e),alert("Pesan diterima")});
