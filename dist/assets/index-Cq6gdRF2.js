 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function io(e=vn()){return ro().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),ne(ee(e),"messaging").getImmediate()}async function ao(e,t){return e=ee(e),ct(e,t)}function so(e,t){return e=ee(e),oo(e,t)}no();const co={apiKey:"AIzaSyBgrvali7O7aNZazdai_Gh1nBIcc2FCp6Y",authDomain:"test-d30ea.firebaseapp.com",projectId:"test-d30ea",storageBucket:"test-d30ea.firebasestorage.app",messagingSenderId:"636987858623",appId:"1:636987858623:web:a71f77a5e79ef2d4d4f00a",measurementId:"G-8MTVH1VKWY"},uo=$e(co),ut=io(uo);function lo(){Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),ao(ut,{vapidKey:"BKR3M4vyA_kUFwmdErwwQb7Xg360bwmp8JendZkeF7oOMdv1tKH1Ce7f53y3rDqTuLQbrztMTmEfdMac67A_uo8"}).then(t=>{t?(console.log("Token: ",t),document.getElementById("app").innerHTML=t):console.log("No registration token available.")}).catch(t=>{console.log("An error occurred while retrieving token: ",t)})):console.log("Unable to get permission to notify.")})}so(ut,function(e){console.log("Pesan diterima:",e),alert("Pesan diterima")});lo();
